...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_TABLE_2 = "Endbewertung";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        try {
            ...
            Log.d(LOG_TAG, "Die Daten werden mit SQL-Befehl: " + SQL_INSERTDB2_2 + " in die Tabelle eingefuegt.");
            db.execSQL(SQL_INSERTDB2_2);
            Log.d(LOG_TAG, "Die Daten werden mit SQL-Befehl: " + SQL_INSERTDB2_3 + " in die Tabelle eingefuegt.");
            db.execSQL(SQL_INSERTDB2_3);
            Log.d(LOG_TAG, "Die Daten werden mit SQL-Befehl: " + SQL_INSERTDB2_4 + " in die Tabelle eingefuegt.");
            db.execSQL(SQL_INSERTDB2_4);
            Log.d(LOG_TAG, "Die Daten werden mit SQL-Befehl: " + SQL_INSERTDB2_5 + " in die Tabelle eingefuegt.");
            db.execSQL(SQL_INSERTDB2_5);
            Log.d(LOG_TAG, "Die Daten werden mit SQL-Befehl: " + SQL_INSERTDB2_6 + " in die Tabelle eingefuegt.");
            db.execSQL(SQL_INSERTDB2_6);
        }
        catch (Exception ex) {
